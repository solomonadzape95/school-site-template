      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className='lg:col-span-3'>
            ...
            <h3 className="text-2xl font-bold mb-6 mt-2">Lasa Schools</h3>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Excellence in Education Since 1975. We are committed to providing quality education 
              and fostering academic excellence, character development, and spiritual growth.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <a href="mailto:info@lasaschools.edu.ng" className="text-gray-300 hover:text-white transition-colors">
                  info@lasaschools.edu.ng
                </a>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Sat: 9:00 AM - 1:00 PM</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              © {currentYear} Lasa Schools. All rights reserved.
            </p>
